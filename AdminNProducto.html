    ...
    <div id="container">
        <div class="overlay" id="overlay">
            ...
            <div class="popup" id="popup">
                ...
                <form action="BD/inserZap.php" method="POST">
                    ...
                    <div class="contenedor-inputs">
                        ...
                        <input type="text" name = "modelo" placeholder="Codigo P">
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-list"></i>Listar usuarios</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        ...
                                        <a href="AdminProveedor.php"><i class="fa fa-plus"></i>Nuevo Proveedor</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-list"></i>Listar proveedores</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <section id="main-content">
                ...
                <article>
                    ...
                    <div id="container1">
                        <div>
                            <br>
                            <a href="#" id="btn-abrir-popup" class="btn btn-success" data-toggle="modal">Agregar zapato</a>
                        ...
                        <table border="1" class="table table-hover table-bordered" id="tablee">
                            ...
                            while($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <a href= "BD/editZap.php?id_zapato=<?php echo $row['id_zapato']?>">
                                    ...
                                    <a href= "BD/deleteZap.php?id_zapato=<?php echo $row['id_zapato']?>">
