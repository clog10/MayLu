...
<body>
    ...
    <div id="container">
        <div class="overlay" id="overlay">
            ...
            $sql_articulos = "SELECT * FROM usuario LIMIT :inicar,:narticulos";
            ...
            <div class="popup" id="popup">
                ...
                <h5><label>*</label> Campo obligatorio <br>
                    ...
                    (Debe contener letras minúsculas, mayúsculas, números y símbolos)
                </h5>
                <form method="post" action="nuevoUsuario.php">
                    ...
                    <div class="contenedor-inputs">
                        ...
                        <input type="text" name="nombre_com" placeholder="Nombre completo" onkeypress="return sololetras(event)" required>
                        <select name="puesto" class="select" required>
                            <option selected value="0"> Elige una opción </option>
                            <option value="1">Admistrador</option>
                            <option value="2">Vendedor</option>
                            <option value="3">Almacenista</option>
                        </select>
                        <select name="id_caja" class="select" required>
                            <option selected value="0"> Elige una opción </option>
                        ...
                        <input type="text" name="tel" placeholder="Teléfono" onkeypress="return solonumeros(event)" required>
            ...
            <section id="main-content">
                ...
                <article>
                    ...
                    <header id="encabezado">
                        <img id="img-inventario" class="img-responsive img-rounded" src="img/usuario.png" height="150" width="150" alt="Usuario picture">
                        <br>
                        <br>
                        <h1>Usuarios</h1>
                    </header>
                    ...
                    <div id="container1">
                        ...
                        <form>
                            <div class="field" id="searchform">
                                <input type="text" id="searchterm" name="introducemodelo" placeholder="Ingresar nombre de usuario" required />
                            ...
                            <tbody>
                                <?php foreach ($resultado_articulos as $usuario) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn actualiza-tabla" href="<?php echo "ActualizarUsuario.php?id_usuario=" . $usuario->id_usuario ?>"><i class="fa fa-edit"></i> Editar</a>
                                            <br>
                                            <br><a class="btn btn-danger" href="<?php echo "eliminarUsuario.php?id_usuario=" . $usuario->id_usuario ?>""><i class=" fas fa-trash"></i> Eliminar</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            ...
                            <nav aria-label="Page navigation example">
                                ...
                                <ul class="pagination ">
                                    <li class="page-item
                                        ...
                                        <a class="page-link" href="Usuario-Administrador.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">
                                            Anterior
                                        </a>
                                    </li>
                                    ...
                                    <?php for ($i = 0; $i < $paginas; $i++) : ?>
                                        ...
                                        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>">
                                            <a class="page-link" href="Usuario-Administrador.php?pagina=<?php echo $i + 1 ?>">
                                                <?php echo $i + 1 ?>
                                            </a>
                                        </li>
                                    <?php endfor ?>
                                    ...
                                    <li class="page-item
                                            ...
                                            "><a class="page-link" href="Usuario-Administrador.php?pagina=<?php echo $_GET['pagina'] + 1 ?>">Siguiente</a></li>
                                </ul>
                            </nav>
                        </div>
                        <br>
    ...
    <script src="js/administrador/AlertarEliminacion.js"></script>
