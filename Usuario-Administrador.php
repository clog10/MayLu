                                ...
                                <nav aria-label="Page navigation example">
                                    ...
                                    <ul class="pagination ">
                                        <li class="page-item
                                            ...
                                            <a class="page-link" 
                                               href="Usuario-Administrador.php?pagina=<?php echo $_GET['pagina']-1 ?>">
                                                Anterior
                                            </a>
                                        </li>
                                        ...
                                        <li class="page-item <?php echo $_GET['pagina']==$i+1 ?'active':'' ?>">
                                            <a class="page-link" 
                                               href="Usuario-Administrador.php?pagina=<?php echo $i+1 ?>">
                                                <?php echo $i+1 ?>
                                            </a>
                                        </li>
                                        <?php endfor ?>
                                        ...
                                        <li class="page-item
                                            ...
                                            "><a class="page-link"
                                             href="Usuario-Administrador.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav>  
                            </div>
                            <br>
