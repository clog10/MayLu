        ...
        <section class="right" id="right">
            ...
            <form action="login.jsp" method="post">
                <div class="container2">
                    ...
                    <input type="password" pattern="[A-Za-z0-9@#$%]{8,20}" minlength="8" maxlength="20" name="introducir_pass" id="pass" required="obligatorio" placeholder="Ingresa tu contraeña">
