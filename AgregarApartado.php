                    ...
                    <div class="actualiza">
                        ...
                        <form action="apartadoc.php" method="post" name="datosrecibido">
                            ...
                            <div class="contenedor-inputs-actualiza">
                                ...
                                <select name="modelo" id="modelos" class="select" onchange="buscar()">
                                    ...
                                    $sentencia->execute([$modelos]);
                                    $code = $sentencia->fetch(PDO::FETCH_OBJ);
                                    if ($code === FALSE) {
                                ...
                                <input type="text" readonly name="numero" placeholder="Talla" onkeypress="return sololetras(event)" value="<?php echo $code->talla ?>">

                                <input type="text" readonly name="color" placeholder="Color" onkeypress="return sololetras(event)" value="<?php echo $code->color ?>">
                                <input type="text" readonly name="precio" placeholder="Precio" onkeypress="return solonumeros(event)" value="<?php echo $code->precioVenta ?>">
