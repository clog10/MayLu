            ...
            <section id="main-content">
                ...
                <article>
                    ...
                    <header id="encabezado">
                        <img id="img-inventario" class="img-responsive img-rounded" src="img/usuario.png"
                            height="150" width="150" alt="Usuario picture">
                        <br>
                        <br>
                        <h1>Usuarios</h1>
                    </header>
                    ...
                    <div id="container1">
                        <div>
                            <br>
                            <a href="#" id="btn-abrir-popup" class="btn btn-success" data-toggle="modal">Agregar usuario</a>
