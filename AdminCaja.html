                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="AdminNProducto.php"><i class="fa fa-plus"></i>
                                            Nuevo producto
                                        </a>
                                    </li>
                                    <!--<li>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="AdminUsuario.php"><i class="fa fa-plus"></i>Nuevo Usuario</a>
                                    </li>
                                    <li>
                                        <a href="#">
            ...
            <section id="main-content">
                ...
                <article>
                    ...
                    <header id="encabezado">
                        <img id="img-inventario" class="img-responsive img-rounded" src="img/caja.png"
                            height="150" width="150" alt="Caja picture">
                        <br>
                        <br>
                        <h1>Caja</h1>
                    </header>
                    ...
                    <div id="container1">
                        <div>
                            <br>
                            <a href="#" id="btn-abrir-popup" class="btn btn-success" data-toggle="modal">Agregar caja</a>
