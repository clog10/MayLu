...
<html lang="es">
    ...
    <body >
		...
		<form method="post" action="agregarAlCarrito.php">
			<label for="codigo ">Modelo de zapato:</label>
			<input autocomplete="off" autofocus class="form-control col-sm-5 " name="codigo" required type="text" id="codigo" placeholder="Escribe el código">
		</form>
		<br><br>
