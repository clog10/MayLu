            ...
            <section id="main-content">
                ...
                <article>
                    ...
                    <header id="encabezado">
                        <img id="img-inventario" class="img-responsive img-rounded" src="img/prove.png"
                            height="150" width="150" alt="Proveedor picture">
                        <br>
                        <br>
                        <h1>Proveedores</h1>
                    </header>
                    ...
                    <div id="container1">
                        <div>
                            <br>
                            <a href="#" id="btn-abrir-popup" class="btn btn-success" data-toggle="modal">Agregar proveedor</a>
